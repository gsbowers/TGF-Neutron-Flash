...
myNeutronHPMessenger::myNeutronHPMessenger(myNeutronHPphysics* phys)
...
myNeutronHPMessenger::~myNeutronHPMessenger()
{
  delete fThermalCmd;
  delete fPhysDir;
}
...
void myNeutronHPMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{   
