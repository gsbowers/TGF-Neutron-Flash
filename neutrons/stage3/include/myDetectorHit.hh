...
class myDetectorHit : public G4VHit
{
  public:
    ...
    G4double GetGlobalTime() const { return fGlobalTime; };
		...
		// overload less than operator bassed on globaltime
		//bool operator<(const myDetectorHit &rhs) const {return this->GetGlobalTime() < rhs.GetGlobalTime(); } 
...
inline bool myDetectorHit_less(myDetectorHit const *lhs, myDetectorHit const *rhs){
